...
void FontDemo::Draw()
{
    ...
    firecode->Draw(60, 75, "Esta é a fonte Fira Code 12 pontos", black);
    firecode->Draw(60, 105, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", black);
    firecode->Draw(60, 135, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", black);
    ...
    courier->Draw(60, 225, "Esta é a fonte Courier 12 pontos", black, Layer::FRONT, 1.0f, -60);
    courier->Draw(60, 255, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", black, Layer::FRONT, 1.0f, -45);
    courier->Draw(60, 285, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", black, Layer::FRONT, 1.0f, -30);
    ...
    verdana->Draw(60, 345, "Verdana 12", green);
    verdana->Draw(60, 375, "Esta é a fonte Verdana 12 pontos", black, Layer::FRONT, 0.5f);
    verdana->Draw(60, 405, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", black, Layer::FRONT, 0.75f);
    verdana->Draw(60, 435, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", black, Layer::FRONT, 1.50f);    
